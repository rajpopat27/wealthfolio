...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  {
    id: 'spending',
    name: 'Spending Rules and Categories',
    description: 'Access to spending categorization rules and activity category assignments',
    functions: [
      'rules.applyToActivities',
      'categories.list',
      'categories.getAssignments',
      'categories.assignActivity',
      'categories.bulkAssign',
    ],
    riskLevel: 'high',
  },
  {
